    ...
    <div class="container" id="menu">
        ...
        <form action="{{ route('todos.store') }}" method="POST">
            ...
            <div class="flex mb-4">
                ...
                <select class="form-input border-green-500 shadow-none mx-3" id="group_id" name="group_id" onchange="fetchSubjects(this.value)">
            ...
            <div class="flex mb-4">
                ...
                <textarea class="appearance-none border border-green-500 rounded w-full py-2 px-3 text-gray-700 mx-3 resize-none" id="description" name="description" placeholder="コメント">{{ old('description') }}</textarea>
            </div>
            <div class="flex items-center justify-end mx-4 my-5">
                <button class="m-2.5 bg-white hover:bg-gray-100 text-green-500 border border-green-500 font-bold py-3 px-5 rounded focus:outline-none focus:shadow-outline" type="button" onclick="window.history.back();">
                    キャンセル
                </button>
                <input class="bg-green-500 hover:bg-green-700 text-white font-bold py-3 px-5 rounded focus:outline-none focus:shadow-outline" type="submit" value="決定" />
            </div>
        </form>
    </div>
    <script>
