    ...
    <main>
        <div class="h-auto max-w-8xl mx-auto rounded-md bg-green-600 mx-10 mt-24">
            ...
            <div class="h-auto max-w-8xl mx-5 rounded-md bg-green-200">
                <div class="flex ml-1"><input id="acd-check1" class="acd-check" type="checkbox"><img
                        class="object-scale-down h-5 w-5" src="../../../img/task.svg">
                    <p class="ml-1">課題内容<input type="text" class="ml-3 mt-1 rounded-md" name="title" size="15"></input>
                    </p>
                </div>
                <div class="acd-content">
                    <div class="flex">　<img class="object-scale-down h-5 w-5" src="../../../img/date.svg">
                        <p class="ml-1">日付，時間</p>
                    </div>
                    <div class="flex">　<img class="object-scale-down h-5 w-5" src="../../../img/propose.svg">
                        <p class="ml-1">提出先
                    ...
                    <div class="flex">　<img class="object-scale-down h-5 w-5" src="../../../img/tags.svg">
                        <p class="ml-1">タグ</p>
                    </div>
                    <div class="flex">　<img class="object-scale-down h-5 w-5" src="../../../img/memo.svg">
                        <p class="ml-1">メモ</p>
                    </div>
                </div>
            </div><br />
        ...
        <main>
            <div class="h-auto max-w-8xl mx-auto rounded-md bg-green-600 mx-10 my-5">
                ...
                <div class="h-auto max-w-8xl mx-5 rounded-md bg-green-200">
                    <div class="flex ml-1"><input id="acd-check1" class="acd-check" type="checkbox"><img
                            class="object-scale-down h-5 w-5" src="../../../img/task.svg">
                        <p class="ml-1">課題内容<input type="text" class="ml-3 mt-1 rounded-md" name="title"
                                size="15"></input></p>
                    </div>
                    <div class="acd-content">
                        <div class="flex">　<img class="object-scale-down h-5 w-5" src="../../../img/date.svg">
